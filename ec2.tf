module "dev_compute_1" {
  source  = "app.terraform.io/athul_enterprice/compute/modules"
  version = "1.0.0"
...
module "dev_elb_1" {
   source  = "app.terraform.io/athul_enterprice/elb/modules"
  version = "1.0.0"
  environment     = module.dev_vpc_1.environment
  nlbname         = "dev-nlb"
...
module "dev_iam_1" {
   source  = "app.terraform.io/athul_enterprice/iam/modules"
  version = "1.0.0"
  environment         = module.dev_vpc_1.environment
  rolename            = "SaiTMRole"
